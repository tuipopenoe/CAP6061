...
-- ****************************************************************************
    ...
    MinNode2=2
        ...
        VrepX=(-1)*((PobsX[MinNode1]-PRobot[1])/MinDist1)+((PobsX[MinNode2]-PRobot[1])/MinDist1) * (1.5 / MinDist1)
        VrepY=(-1)*((PobsY[MinNode1]-PRobot[2])/MinDist1)+((PobsY[MinNode2]-PRobot[2])/MinDist2) * (1.5 / MinDist2)
        ...
        VattX=(PGoal[1]-PRobot[1])/DistGoal * (DistGoal / 10)
        VattY=(PGoal[2]-PRobot[2])/DistGoal * (DistGoal / 10)
